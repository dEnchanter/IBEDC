    ...
    <div className="relative flex h-screen w-screen flex-col bg-black md:items-center md:justify-center md:bg-transparent">
        ...
        />
          ...
          <form className="relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14" onSubmit={handleSubmit}>
            <h1 className="text-4xl text-white font-semibold text-center">Sign Up</h1>
            <div className='space-y-3'>
              ...
              <label htmlFor="phone" className="inline-block w-full">
                <Input name="phone" placeholder="phone no" />
              </label>

              <label htmlFor="role" className="inline-block w-full">
