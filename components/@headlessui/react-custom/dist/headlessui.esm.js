import React, { Fragment, isValidElement, cloneElement, createElement, forwardRef, useMemo, useCallback, useRef, useEffect, useLayoutEffect, useState, createContext, useContext, useReducer, createRef } from 'react';
...
function Portal(props) {
  ...
  return React.createElement(StackProvider, null, !target || !element ? null : createPortal(render(passthroughProps, {}, DEFAULT_PORTAL_TAG), element));
} // ---
...
var DialogRoot = /*#__PURE__*/forwardRefWithAs(function Dialog(props, ref) {
  ...
  var setDescriptionId = useCallback(function (id) {
    return dispatch({
...
var LabelContext = /*#__PURE__*/createContext({
...
var DescriptionContext = /*#__PURE__*/createContext({
  register: function register() {
    return function () {};
  }
});
...
function RadioGroup(props) {
  ...
  return React.createElement(DescriptionProvider, null, React.createElement(LabelProvider, null, React.createElement(RadioGroupContext.Provider, {
    value: reducerBag
...
function Option$1(props) {
  ...
  return React.createElement(DescriptionProvider, null, React.createElement(LabelProvider, null, render(_extends({}, passThroughProps, propsWeControl), bag, DEFAULT_OPTION_TAG$1)));
} // ---
...
export { Alert, Dialog, Disclosure, FocusTrap, Listbox, Menu, Popover, Portal, RadioGroup, Switch, Transition };
